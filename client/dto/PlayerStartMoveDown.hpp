...
** R-Type-Reborn
** File description:
** PlayerStartMoveDown.hpp
*/

#ifndef PLAYERSTARTMOVEDOWN_HPP
#define PLAYERSTARTMOVEDOWN_HPP
 ...
 */
class PlayerStartMoveDown final: public APlayerDTO {
public:
	/**
	 * @brief The constructor of the PlayerStartMoveDown class
	 ...
	 * @author Aubane NOURRY
	 */
	PlayerStartMoveDown(int playerID);

	/**
     * @brief The destructor of the PlayerStartMoveDown class
     * @version v0.1.0
     * @since v0.1.0
	 * @author Aubane NOURRY
     */
	~PlayerStartMoveDown() override = default;
